// Package app собирает и запускает сервис iam.
package app
...
import (
	...
	"github.com/BakhytzhanulyE/microservices-course-BakhytzhanulyE/iam/migrations"
...
func (a *App) initGRPCServer(ctx context.Context) error {
	...
	iamV1.RegisterAuthServiceServer(a.grpcServer, a.diContainer.IamV1API(ctx))
...
func (a *App) runGRPCServer(ctx context.Context) error {
	logger.Info(ctx, fmt.Sprintf("🚀 gRPC AuthService слушает на %s", config.AppConfig().GRPC.Address()))
