...
import (
	...
	"github.com/BakhytzhanulyE/microservices-course-BakhytzhanulyE/inventory/internal/config/env"
)
...
// Отсутствие файла — не ошибка: в Docker переменные приходят из окружения.
