...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\n" +
	"StringList\x12\x16\n" +
	"\x06values\x18\x01 \x03(\tR\x06values\"\xda\x01\n" +
	"\x05Value\x12#\n" +
	...
	"\vstring_list\x18\x05 \x01(\v2\x18.inventory.v1.StringListH\x00R\n" +
	"stringListB\x06\n" +
	"\x04kind\"\xd5\x04\n" +
	"\x04Part\x12\x12\n" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseBjZhgithub.com/BakhytzhanulyE/microservices-course-BakhytzhanulyE/shared/pkg/proto/inventory/v1;inventory_v1b\x06proto3"
...
var (
	...
	file_inventory_v1_inventory_proto_goTypes   = []any{
		...
		(*StringList)(nil),            // 3: inventory.v1.StringList
		(*Value)(nil),                 // 4: inventory.v1.Value
		(*Part)(nil),                  // 5: inventory.v1.Part
		(*PartsFilter)(nil),           // 6: inventory.v1.PartsFilter
		(*GetPartRequest)(nil),        // 7: inventory.v1.GetPartRequest
		(*GetPartResponse)(nil),       // 8: inventory.v1.GetPartResponse
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	3,  // 0: inventory.v1.Value.string_list:type_name -> inventory.v1.StringList
	...
	11, // 4: inventory.v1.Part.metadata:type_name -> inventory.v1.Part.MetadataEntry
	12, // 5: inventory.v1.Part.created_at:type_name -> google.protobuf.Timestamp
	12, // 6: inventory.v1.Part.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 7: inventory.v1.PartsFilter.categories:type_name -> inventory.v1.Category
	5,  // 8: inventory.v1.GetPartResponse.part:type_name -> inventory.v1.Part
	6,  // 9: inventory.v1.ListPartsRequest.filter:type_name -> inventory.v1.PartsFilter
	5,  // 10: inventory.v1.ListPartsResponse.parts:type_name -> inventory.v1.Part
	4,  // 11: inventory.v1.Part.MetadataEntry.value:type_name -> inventory.v1.Value
	7,  // 12: inventory.v1.InventoryService.GetPart:input_type -> inventory.v1.GetPartRequest
	9,  // 13: inventory.v1.InventoryService.ListParts:input_type -> inventory.v1.ListPartsRequest
	8,  // 14: inventory.v1.InventoryService.GetPart:output_type -> inventory.v1.GetPartResponse
	10, // 15: inventory.v1.InventoryService.ListParts:output_type -> inventory.v1.ListPartsResponse
