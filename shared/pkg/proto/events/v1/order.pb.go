...
func (x *OrderPaid) GetPaymentAmount() float64 {
	if x != nil {
...
const file_events_v1_order_proto_rawDesc = "" +
	"\n" +
	"\x15events/v1/order.proto\x12\tevents.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\x94\x02\n" +
	"\tOrderPaid\x12\x1d\n" +
	"\n" +
	...
	"\apaid_at\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\x06paidAt\"\xcf\x01\n" +
	...
	"\fassembled_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\vassembledAtBdZbgithub.com/BakhytzhanulyE/microservices-course-BakhytzhanulyE/shared/pkg/proto/events/v1;events_v1b\x06proto3"
...
var file_events_v1_order_proto_depIdxs = []int32{
	...
	2, // 1: events.v1.ShipAssembled.assembled_at:type_name -> google.protobuf.Timestamp
