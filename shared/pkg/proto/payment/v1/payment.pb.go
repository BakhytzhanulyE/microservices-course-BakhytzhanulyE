...
const (
	// PAYMENT_METHOD_UNSPECIFIED — способ оплаты не указан.
...
// PayOrderResponse — результат оплаты.
...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"\bPayOrder\x12\x1b.payment.v1.PayOrderRequest\x1a\x1c.payment.v1.PayOrderResponseBfZdgithub.com/BakhytzhanulyE/microservices-course-BakhytzhanulyE/shared/pkg/proto/payment/v1;payment_v1b\x06proto3"
